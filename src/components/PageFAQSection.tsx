...
const PageFAQSection = ({ title, subtitle, faqs }: PageFAQSectionProps) => (
  <section
    className="relative overflow-hidden pb-0 pt-24"
    style={{ background: "linear-gradient(170deg, hsl(268 55% 18%) 0%, hsl(var(--navy)) 55%, hsl(var(--navy)) 100%)" }}
  >
    ...
    <div className="container relative z-10 max-w-5xl pb-24">
      {/* Header */}
      <motion.div
